import sys
sys.path.insert(0,'/home/bswart/irn/step_puzzle')
...
def run(args2):
    ...
    parser.add_argument('--data_dir', default='/home/bswart/data/VOCdevkit/VOC2012/', type=str)
    ...
    log_dir = create_directory('/home/bswart/experiments/puzzle1/logs/')
    data_dir = create_directory(f'/home/bswart/experiments/puzzle1/data/')
    model_dir = create_directory('/home/bswart/experiments/puzzle1/models/')
    tensorboard_dir = create_directory(f'./step_puzzle/experiments/tensorboards/{args.tag}/')
    ...
    meta_dic = read_json('/home/bswart/PuzzleCAM/voc12/VOC_2012.json')
    ...
    def evaluate(loader):
        ...
        meter_dic = {th: Calculator_For_mIoU('/home/bswart/PuzzleCAM/voc12/VOC_2012.json') for th in thresholds}
